...
user
WHERE
mediasosial_alumni.email = datadiri_alumni.email AND pendidikan_alumni.email = datadiri_alumni.email AND pekerjaan_alumni.email = datadiri_alumni.email AND user.email = datadiri_alumni.email";
